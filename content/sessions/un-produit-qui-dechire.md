...
Summary: #### Compléments
Summary: 
Summary: Le format de la session : pas de slide, que du participatif.
Summary: L'originalité : j'interagirai avec mon démon virtuel, le type qui dit "ça ne marchera jamais" qu'on rencontre lors des réunions créatives, matérialisé dans un écran (ce sera une première !)
